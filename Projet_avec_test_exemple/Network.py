        ...
        while not pq.empty():
            ...
            for nextStopId in currentStop.getConnections():
                ...
                if nextStopId == end_stop_id:
                    ...
                    itinerary.append((int(endStop.getId()), self.RouteId2MetroNum[endStop.currentMetro],
                                      ceil(endStop.getDuration()/60)))
                    predStop = endStop.getPred()
                    while True:
                        itinerary.append((int(predStop.getId()), self.RouteId2MetroNum[predStop.currentMetro],
...
if __name__ == "__main__":
    ...
    itiner4, d4 = net.compute_shortest_path("Pont de Sèvres", "Saint-Fargeau", dt4)
    print(itiner4)
