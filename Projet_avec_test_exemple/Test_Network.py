...
class Test_Network(unittest.TestCase):
    ...
    def test_One_route_5_compute_shortest_path_with_weight(self):
        ...
        print("\n")
        print(parcours, duration)
        ref = [(1767, 'transfer', 0), (1843, '5', 4), (1700, '5', 5), (2008, '5', 6),
    ...
    def test_One_route_4_compute_shortest_path_with_weight(self):
        ...
        ref = [(2363, 'transfer', 0), (2442, '4', 6), (2411, '4', 7), (2466, '4', 8),
    ...
    def test_Two_routes_4_5_compute_shortest_path_with_weight(self):
        ...
        print(parcours, duration)
        ref = [(2153, 'transfer', 0), (2208, '4', 1), (2076, 'transfer', 3), (1898, '5', 5), (2294, 'transfer', 5)]
        ...
        print(parcours, duration)
        ref = [(2294, 'transfer', 0), (2125, '5', 3), (2076, 'transfer', 3), (2208, 'transfer', 5), (2212, '4', 7),
    ...
    def test_All_Subway_routes_compute_shortest_path_with_weight(self):
        ...
        ref = [(1804, 'transfer', 0), (2088, '9', 4), (1884, '9', 5), (1747, '9', 7), (1936, '9', 9), (1816, '9', 10),
               ...
               (1647, '9', 37), (2527, 'transfer', 37), (2376, 'transfer', 39), (2389, '3', 40), (2471, '3', 42),
               (2395, '3', 43), (2205, '3', 45), (1950, 'transfer', 45), (2539, 'transfer', 47),
